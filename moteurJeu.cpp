...
int main(int argc, char** argv)
{
    ...
    p1.init(Vect3D(0, 20, 0), Vect3D(0, 0, 0), Vect3D(0, 0, 0));
    ...
    SpringForceGenerator sfg = new SpringForceGenerator(p2, 15.f, 2.f); // PB référence p2
    BungeeSpringForceGenerator bsfg = new BungeeSpringForceGenerator(p2, 15.f, 2.f); // Idem
    AnchoredSpringForceGenerator asfg = new AnchoredSpringForceGenerator(Vect3D(0, 10, 0), 30.f, 0.5f); // OK
    FloatingSpringForceGenerator fsfg = new FloatingSpringForceGenerator(Vect3D(0, 5, 0), 1000.f, 2.f, 4.f * 3.14f);
