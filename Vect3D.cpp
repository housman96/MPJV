...
float Vect3D::getX() { return x; }

float Vect3D::getY() { return y; }
float Vect3D::getZ() { return z; }

void Vect3D::setX(float x) { this->x = x; }

void Vect3D::setY(float y) { this->y = y; }
void Vect3D::setZ(float z) { this->z = z; }
...
float Vect3D::mag() { return sqrt(x * x + y * y + z * z); }

float Vect3D::magSq() { return x * x + y * y + z * z; }
